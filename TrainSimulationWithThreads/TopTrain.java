...
public class TopTrain extends Thread {
  // Atributos:
  ...
  // Construtor:
  public TopTrain(Pane trainPane, Path trainPath) {
    ...
    this.trainPath.setStroke(Color.rgb(0, 255, 0, 1));
  }
      ...
      Platform.runLater(() -> {
        if (trainMovement != null) {
          ...
          trainMovement.currentTimeProperty().addListener((observable, oldValue, newValue) -> {
            ...
            System.out.println("T1 pos: " + yPosition);
